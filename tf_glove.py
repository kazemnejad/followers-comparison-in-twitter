...
class GloVeModel():
    ...
    def load_attrs(self, embd, words, ids):
        self.__embeddings = embd
        self.__words = words
        self.__word_to_id = ids
    ...
    def __fit_to_corpus(self, corpus, vocab_size, min_occurrences, left_size, right_size):
        ...
        for region in corpus:
            r_count += 1
            print("region #", r_count, len(corpus))
    ...
    def train(self, num_epochs, log_dir=None, summary_batch_interval=1000,
              tsne_epoch_interval=None, on_epoch_finished=None):
        ...
        with tf.Session(graph=self.__graph) as session:
            ...
            for epoch in range(num_epochs):
                ...
                for batch_index, batch in enumerate(batches):
                    ...
                    print("# %s/%s - total loss:%s" % (batch_index, len(batches), loss))
